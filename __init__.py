...
class coFunc(collections.Sequence):  # MutableSequence?
    ...
    def _mathop(self, other, otype):
        ...
        if type(other) is type(self):
            ...
            return type(self)(x=x, y=y,
                              attrs=self.attrs.intersection(other.attrs))
        else:
...
class coFunc2d(object):  # collections.Sequence? collections.MutableSequence?
